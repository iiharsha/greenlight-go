...
func (m UserModel) GetForToken(tokenScope, tokenPlaintext string) (*User, error) {
	// Sum256() returns a byte *array* not a slice.
	...
	// we use [:] operator to get a slice containing the tokenHash
	// *we cannot pass an array since pq driver does not support it*
